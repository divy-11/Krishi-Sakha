    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div className="bg-white py-10 px-12 rounded-3xl drop-shadow-lg">
                ...
                <div className="pt-8">
                    <Input label={"Name"} placeholder={"Rohil"}
                    // onChange={
                    //     (e) => {
                    //     setuserInputs(c => ({
                    //         ...c,
                    ...
                    // }}
                    />
                    <Input label={"City"} placeholder={"Dhanbad"}></Input>
                    <Input label={"State"} placeholder={"Jharkhand"}></Input>
                    ...
                    // }} 
                    />
                    <button type="button" className="w-full mt-8 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">Sign Up</button>
                </div>
            </div>
        </div>
    </div>
